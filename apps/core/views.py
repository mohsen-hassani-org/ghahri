...
from .models import CareerGroup, UserAlert
...
class AlertListView(PermissionRequireMixin, GenericModelListView):
...
class CareerGroupJobsAjaxView(PermissionRequireMixin ,View):
    permissions = [User.Roles.ADMIN]
